...
<div id="contentpane">
	...
	<div class="left">
		<select name="dusun" onchange="formAction('mainform','<?php echo site_url('analisis_respon/dusun')?>')">
			<option value="">Kampung/Kelurahan</option>
			<?php foreach($list_dusun AS $data){?>
				<option value="<?php echo $data['dusun']?>" <?php if($dusun == $data['dusun']) :?>selected<?php endif?>><?php echo ununderscore($data['dusun']) ?></option>
			<?php }?>
		</select>
