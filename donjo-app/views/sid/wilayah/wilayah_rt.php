...
<div id="contentpane">
    ...
    <h3>Wilayah Administratif RT (RW <?php echo $rw?> / Dusun <?php echo unpenetration(ununderscore($dusun))?>)</h3>
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url("sid_core/form_rt/$id_kecamatan/$id_dusun/$rw")?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus-square">&nbsp;</span>Tambah RT</a>
    ...
    <div class="ui-layout-south panel bottom">
        <div class="left">
        <div class="left">
            <a href="<?php echo site_url("sid_core/sub_rw/$id_kecamatan/$id_dusun")?>" class="uibutton icon prev">Kembali</a>
        </div>
        </div>
        <div class="right">
        </div>
