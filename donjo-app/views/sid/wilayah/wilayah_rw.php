    ...
    <h3>Wilayah Administratif RW (<?php echo ucwords($this->setting->sebutan_dusun)?> <?php echo unpenetration(ununderscore($dusun))?>)</h3>
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url("sid_core/form_rw/$id_kecamatan/$id_dusun")?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus-square">&nbsp;</span>Tambah RW</a>
...
<a href="<?php echo site_url("sid_core/sub_rt/$id_kecamatan/$id_dusun/$data[rw]")?>"  class="uibutton tipsy south" title="Rincian Sub Wilayah"><span class="fa fa-list"></span> Rincian</a>
    ...
    <div class="ui-layout-south panel bottom">
        <div class="left">
        <div class="left">
            <a href="<?php echo site_url("sid_core/sub_kampung/$id_kecamatan")?>" class="uibutton icon prev">Kembali</a>
        </div>
        </div>
        <div class="right">
        </div>
