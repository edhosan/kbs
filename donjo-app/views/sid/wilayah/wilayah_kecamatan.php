...
<div id="contentpane">
    ...
    <h3>Wilayah Administratif <?php echo ucwords($this->setting->sebutan_kecamatan)?></h3>
        <div class="left">
            <div class="uibutton-group">
            <?php if($grup!=4) { ?>
	            <a href="<?php echo site_url('sid_core/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus-square">&nbsp;</span>Tambah <?php echo ucwords($this->setting->sebutan_kecamatan)?></a>
            <?php } ?>
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<thead>
            <tr>
				...
				<th width="200">Nama <?php echo ucwords($this->setting->sebutan_kecamatan)?></th>
				<th width="200">Nama Kepala <?php echo ucwords($this->setting->sebutan_camat)?></th>
				<th width="50">Kampung</th>
				<th width="50">RW</th>
				<th width="50">RT</th>
				<th width="50">KK</th>
				<th width="50">Jiwa</th>
		...
		<tr>
          <td align="center" width="2"><?php echo $data['no']?></td>
			...
			<td width="4" align="center"><div class="uibutton-group">
				<a href="<?php echo site_url("sid_core/sub_kampung/$data[id]")?>" class="uibutton tipsy south fa-tipis" title="Rincian Sub Wilayah"><span class="fa fa-bars"></span> Rincian</a>
				<?php if($grup!=4) { ?>
					<a href="<?php echo site_url("sid_core/form/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="fa fa-edit"></span></a>
				<?php } ?>

<?php  if($grup==1){?>
				<a href="<?php echo site_url("sid_core/delete/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin? Menghapus data kecamatan akan mempengaruhi struktur data yang ada dibawah kecamatan. pilih tidak untuk membatalkan penghapusan." header="Hapus Data"><span class="fa fa-trash"></span></a><?php  } ?>
</div>
			</td>
			<td><?php echo strtoupper(unpenetration(ununderscore($data['kecamatan'])))?></td>
			<td><?php echo strtoupper(unpenetration($data['nama_kacamat']))?></td>

			<td align="center"><a href="<?php echo site_url("sid_core/sub_kampung/$data[id]")?>" title="Rincian Sub Wilayah"><?php echo $data['jumlah_kampung']?></a></td>
        ...
        <?php
        $total['total_kampung'] += $data['jumlah_kampung'];
        ...
        endforeach; ?>
            ...
            <tr style="background-color:#BDD498;font-weight:bold;">
                <td colspan="5" align="center"><label>TOTAL</label></td>
   				<td align="center"><?php echo $total['total_kampung']?></td>
