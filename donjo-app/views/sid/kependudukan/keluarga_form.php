...
<tr>
  ...
  <td>
    <select name='kecamatan' onchange="formAction('mainform','<?php echo site_url('keluarga/form/0/1')?>')" <?php if($kecamatan){?>class="required" <?php }?>>
...
<tr>
  <th>RT</th>
  <td><select name="rt" onchange="formAction('mainform','<?php echo site_url('keluarga/form/0/1')?>')" >
