    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
        <div class="table-panel top">
            <div class="left">
                <select name="filter" onchange="formAction('mainform','<?php echo site_url('man_user/filter')?>')">
                    ...
                    <option value="4" <?php if($filter==4) :?>selected<?php endif?>>Fasilitator</option>
                </select>
            </div>
            <div class="right">
		...
		<tr>
          ...
          <td><div class="uibutton-group">
            <?php if($data['grup']=='Fasilitator'){ ?>
                <a href="<?php echo site_url("man_user/wilayah_kerja/$p/$o/$data[id]")?>" class="uibutton tipsy south fa-tipis" title="Wilayah Kerja"><span class="fa fa-leanpub"></span> Wilayah Kerja</a>
            <?php } ?>
