...
function __construct(){
	...
	function index($p=1,$o=0){
		...
		$this->load->view('sid/wilayah/wilayah_kecamatan',$data);
		$this->load->view('footer');
	}

	function sub_kampung($id_kecamatan=""){
		...
		$data['main']     = $this->wilayah_model->list_data_kampung($id_kecamatan );
	...
	function form($id=''){
		...
		if($id){
			$this->wilayah_model->cluster_by_id($id);
		...
		$this->load->view('header',$header);
		$this->load->view('sid/nav',$nav);
		$this->load->view('sid/wilayah/wilayah_form_kecamatan',$data);
		$this->load->view('footer');
		
	}

	function form_kampung($id_kecamatan="", $id_kampung=""){
		$data['penduduk'] = $this->wilayah_model->list_penduduk();
		...
		if($id_kampung){
			...
			$data['dusun']          = null;
			$data['form_action'] = site_url("sid_core/insert/$id_kecamatan");
		}
	...
	function insert($id_kecamatan=''){
		...
		$this->wilayah_model->insert($id_kecamatan);
		redirect("sid_core/sub_kampung/$id_kecamatan");
	}
	...
	function sub_rw($id_kecamatan='', $id_dusun=''){
	...
	function form_rw($id_kecamatan='', $id_dusun='',$rw=''){
		...
		if($rw){
			...
			$data['rw']          = null;
			$data['form_action'] = site_url("sid_core/insert_rw/$id_kecamatan/$id_dusun");
		}
	...
	function insert_rw($id_kecamatan='', $dusun=''){
		$this->wilayah_model->insert_rw($dusun);
		redirect("sid_core/sub_rw/$id_kecamatan/$dusun");
	}
	...
	function sub_rt($id_kecamatan='', $id_dusun='',$rw=''){
	...
	function form_rt($id_kecamatan='',$id_dusun='',$rw='',$rt=''){
		...
		if($rt){
			...
			$data['rt']          = null;
			$data['form_action'] = site_url("sid_core/insert_rt/$id_kecamatan/$id_dusun/$rw");
		}
	...
	function insert_rt($id_kecamatan='', $dusun='',$rw=''){
		$this->wilayah_model->insert_rt($id_kecamatan,$dusun,$rw);

		redirect("sid_core/sub_rt/$id_kecamatan/$dusun/$rw");
	}
